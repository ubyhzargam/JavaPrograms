...
class Insert
{
    ...
    public static void main(String []args)
    {
        ...
        System.out.println("Enter the element you want to insert at the beginning of the doubly linked list");
        int x=sc.nextInt();
        head=InsertBeg(head,x);
        System.out.println("The modified doubly linked list after inserting element at the beginning is given by");
        curr=head;
        while(curr!=null)
        {
